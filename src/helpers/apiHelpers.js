...
export const currentUserFollowersUser = (currentUsername, username) =>
  ...
  export const userFollowsOtherUser = (currentUsername, username) =>
  SteemAPI.sendAsync('call', [
    'follow_api',
    'get_following',
    [currentUsername, username, 'blog', 1],
  ]);

  export const getRebloggedBy = (author, permlink) =>
  SteemAPI.sendAsync('get_reblogged_by', [author, permlink]);